    ...
    <div class="box">
      <div class="content">
        ...
        <div class="form-group">
            ...
            <table class="table table-striped">
              <thead>
                <tr class="info">
                  ...
                  <th><div align="center">
                      <h5><span class="clearfix">CARGO</span></h5>
                    </div></th>
                  <th><div align="center">
                      <h5><span class="clearfix">ÁREA</span></h5>
                    </div></th>
                  <th><div align="center">
              ...
              <tbody>
                <?php $cont=0; while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { $cont++; $colegiado= $row['trab_colegiado_id'];?>
                <tr>
                  <td><h6><span class="clearfix"><?php echo $cont; ?></span></h6></td>
                  <td><h6><span class="clearfix"><?php echo $row['trab_institu']; ?></span></h6></td>
                  <td><h6><span class="clearfix"><?php echo $row['trab_cargo']; ?></span></h6></td>
                  <td><h6><span class="clearfix"><?php echo $row['trab_area']; ?></span></h6></td>
                  <td><h6><a href="trab_modif_editar.php?id=<?php echo $row['trab_id']; ?>"><span class="glyphicon glyphicon-pencil"> EDITAR</span></a></h6></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
          ...
          <div class="form-group">
            <input type="button" name="nuevo" class="btn btn-info" value="AGREGAR" onclick="location.href='trab_modif_agregar.php?id=<?php echo $colegiado; ?>'"/>
